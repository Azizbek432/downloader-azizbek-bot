export const messages = {
  ...
  ru: {
    ...
    success: (botName) => `✅ Видео успешно скачано!\n\n🤖 @${botName}`,
  ...
  en: {
    ...
    success: (botName) => `✅ Video downloaded successfully!\n\n🤖 @${botName}`,
